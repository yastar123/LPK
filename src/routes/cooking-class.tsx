...
export const Route = createFileRoute("/cooking-class")({
  head: () => ({
    meta: [
      { title: "Cooking Class — Ich Liebe Deutsch Medan" },
      {
        name: "description",
        content:
          "Cooking Class Ich Liebe Deutsch Medan: seluruh peserta Aupair dibekali kemampuan memasak sebagai bekal hidup dan mengasah keterampilan praktis sebelum berangkat ke Jerman.",
      },
      { property: "og:title", content: "Cooking Class — Ich Liebe Deutsch Medan" },
      {
        property: "og:description",
        content:
          "Sesi cooking class Ich Liebe Deutsch Medan untuk membekali peserta Aupair dengan kemampuan memasak sebelum berangkat ke Jerman.",
      },
...
const POINTS = [
  {
    title: "Keterampilan Memasak",
    desc: "Mempelajari berbagai resep masakan Indonesia maupun Jerman sebagai bekal hidup mandiri di Jerman.",
  },
  {
    title: "Kemandirian Peserta",
    desc: "Seluruh peserta Aupair diharapkan mempunyai kemampuan memasak untuk membantu tugas sehari-hari di gastfamily.",
  },
  {
    title: "Kebersamaan",
    desc: "Sesi memasak bersama mempererat hubungan antar peserta sekaligus membangun rasa percaya diri.",
  },
];

const PHOTOS = [
  { src: galleryCooking, alt: "Cooking class peserta Aupair", caption: "Cooking Class (1)" },
  { src: galleryClass, alt: "Persiapan bahan masakan", caption: "Cooking Class (2)" },
  { src: galleryGathering, alt: "Memasak bersama peserta", caption: "Cooking Class (3)" },
  { src: galleryStudy, alt: "Sesi cooking class", caption: "Cooking Class (4)" },
  { src: galleryCity, alt: "Menyajikan hasil masakan", caption: "Cooking Class (5)" },
  { src: galleryCooking, alt: "Suasana cooking class", caption: "Cooking Class (6)" },
];
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-[42vh] flex-col justify-center px-6 py-24 md:min-h-[48vh]">
          ...
          <p className="mt-5 max-w-[60ch] text-pretty text-lg leading-relaxed text-surface/75">
            Seluruh peserta Aupair diharapkan mempunyai kemampuan memasak. Cooking Class German
            Education membekali peserta dengan keterampilan praktis sebelum berangkat ke Jerman.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mb-14 text-center">
            ...
            <p className="mb-3 text-[11px] font-semibold uppercase tracking-widest text-primary">
              Tujuan Cooking Class
            </p>
            <h2 className="font-display text-3xl leading-tight md:text-4xl">
              Bekal memasak untuk hidup di Jerman
            </h2>
            <p className="mx-auto mt-3 max-w-[60ch] text-pretty text-muted-foreground">
              Peserta Aupair akan tinggal bersama gastfamily, sehingga kemampuan memasak menjadi
              keterampilan penting yang terus dilatih dalam sesi cooking class.
            </p>
          </div>
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-8 px-6 md:flex-row md:items-center">
          <div>
            <h2 className="max-w-[24ch] text-balance font-display text-3xl leading-tight md:text-4xl">
              Ingin ikut cooking class Ich Liebe Deutsch Medan?
            </h2>
